        ...
        $(document).ready(function() {
			bfdsmgr.contacts.getSystem();
	      	bfdsmgr.contacts.getStates();
	       	...
	       	bfdsmgr.contacts.editContactPage();
        });
    </script>
</head>
...
<div class="bfdsmgrMgmtBody">
	<div id="editContact">
          <div style="text-align: center;">
			<h3 class="pageHeaderTableHeader">Edit Contact</h3>
          </div>
          ...
          <div>
              <label>Select:</label>
              &nbsp;
              <input id="systemSubmit" name="system" type="submit" value="System" onclick="bfdsmgr.contacts.systemDialog()"/>
          </div>
          <br/>          
          <table>
	          <tr>
          ...
          <br/>
          <div>
			<input type="button" value="Submit" id="submitContact" onclick="bfdsmgr.contacts.updateContact();"/>
          </div>
    </div>
