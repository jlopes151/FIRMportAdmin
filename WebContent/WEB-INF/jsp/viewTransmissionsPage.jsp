...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
           bfdsmgr.trans.initializeFilteredGrid();
        });
        /*
        ...
        */
        function setRowToEdit(event){
        	bfdsmgr.trans.setRowToEdit(event);
        }
        function activateEditPage(event){
        	bfdsmgr.trans.activateEditPage(event);
        }
    </script>
</head>
...
<div class="bfdsmgrMgmtBody">
    ...
    <div id="title" class="bfdsmgrCenter bfdsHidden"><h3 id="titleHeader">Transmission</h3></div>
    <div id="currentTrans" class="bfdsmgrMgmtBody"></div>    
</div>
</body>
</html>