	...
	<body>
		...
		<div id="navigation-block">
        	<ul id="sliding-navigation">
                ...
                <%-- Menu 1 --%>
                <li class="sliding-element"><a href="#">Branch</a>
					<ul id="subMenu0">
						<li><a id="view_branch" class="sub-menu-element" href="#" onclick="setFieldPage('viewBranchsPage');return true">View</a></li>
						<li><a id="add_branch" class="sub-menu-element" href="#" onclick="setFieldPage('addBranchPage');return true">Add</a></li>
						<li><a id="delete_branch" class="sub-menu-element" href="#" onclick="setFieldPage('admin/add');return true">Delete</a></li>
					</ul>
				</li>
		...
		<div>
			<iframe src="viewBranchsPage" id="field-block" frameborder="0"></iframe>
		</div>
	</body>
</html>