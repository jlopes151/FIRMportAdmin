...
<head>
    ...
    <title>FIRMport Admin - Agreement Page</title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
           bfdsmgr.agree.initializeFilteredGrid();
        });
        /*
        ...
        */
        function setRowToEdit(event){
        	bfdsmgr.agree.setRowToEdit(event);
        }
        function activateEditPage(event){
        	bfdsmgr.agree.activateEditPage(event);
        }
    </script>
</head>
...
<div class="bfdsmgrMgmtBody">
    ...
    <div id="currentAgreement" class="bfdsmgrMgmtBody"></div>    
</div>
</body>
</html>