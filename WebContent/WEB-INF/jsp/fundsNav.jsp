	...
	<body>
		...
		<div id="navigation-block">
        	<ul id="sliding-navigation">
                ...
                <%-- Menu 1 --%>
                <li class="sliding-element"><a href="#">Funds</a>
					<ul id="subMenu0">
						<li><a id="view_fund" class="sub-menu-element" href="#" onclick="setFieldPage('viewFundsPage');return true">View</a></li>
						<li><a id="add_fund" class="sub-menu-element" href="#" onclick="setFieldPage('addFundPage');return true">Add</a></li>
						<li><a id="delete_fund" class="sub-menu-element" href="#" onclick="bfdsmgr.funds.deleteFund();return true">Delete</a></li>
					</ul>
				</li>
				
                <%-- Menu 2 --%>
                <li class="sliding-element"><a href="#">Class</a>
					<ul id="subMenu4">
						<li><a id="view_fund" class="sub-menu-element" href="#" onclick="setFieldPage('viewFundsPage');return true">View</a></li>
						<li><a id="add_fund" class="sub-menu-element" href="#" onclick="setFieldPage('addFundPage');return true">Add</a></li>
						<li><a id="delete_fund" class="sub-menu-element" href="#" onclick="bfdsmgr.funds.deleteFund();return true">Delete</a></li>
		...
		<div>
			<iframe src="viewFundsPage" id="field-block" frameborder="0"></iframe>
		</div>
	</body>
</html>