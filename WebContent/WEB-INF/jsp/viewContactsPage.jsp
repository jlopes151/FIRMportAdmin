...
<head>
    ...
    <title>FIRMport Admin - Manage Contacts Page</title>
...
<div class="bfdsmgrMgmtBody">
    ...
    <div id="title" class="bfdsmgrCenter bfdsHidden"><h3 id="titleHeader">Manage Contacts</h3></div>
    <div id="currentContacts" class="bfdsmgrMgmtBody"></div>    
</div>
</body>
</html>