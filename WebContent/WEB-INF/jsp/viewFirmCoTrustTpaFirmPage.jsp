...
<head>
    ...
    <title>FIRMport Admin - Firm Company Trust Tpa Page</title>
    ...
    <script type="text/javascript" src="bfdsFirmCoTrstTpaFirm.js"></script>
    <script type="text/javascript">
        $(document).ready(function() {
           bfdsmgr.fcttf.initializeFilteredGrid();
        });
        /*
        ...
        */
        function setRowToEdit(event){
        	bfdsmgr.fcttf.setRowToEdit(event);
        }
        function activateEditPage(event){
        	bfdsmgr.fcttf.activateEditPage(event);
        }
    </script>
</head>
...
<div class="bfdsmgrMgmtBody">
    ...
    <div id="title" class="bfdsmgrCenter bfdsHidden"><h3 id="titleHeader">Firm Company Trust Tpa</h3></div>
