	...
	<body>
		...
		<div id="navigation-block">
        	<ul id="sliding-navigation">
                ...
                <%-- Menu 1 --%>
                <li class="sliding-element"><a href="#">Alerts</a>
					<ul id="subMenu0">
						<li><a id="view_alert" class="sub-menu-element" href="#" onclick="setFieldPage('viewAlertsPage');return true">View</a></li>
						<li><a id="add_alert" class="sub-menu-element" href="#" onclick="setFieldPage('addAlertPage');return true">Add</a></li>
						<li><a id="delete_alert" class="sub-menu-element" href="#" onclick="setFieldPage('deleteAlertPage');return true">Delete</a></li>
					</ul>
				</li>
		...
		<div>
			<iframe src="viewAlertsPage" id="field-block" frameborder="0"></iframe>
		</div>
	</body>
</html>