...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
			...
			bfdsmgr.contacts.editContactMgmtcoXrfPage();
...
<div class="bfdsmgrMgmtBody">
	<div id="editContact">
          <div style="text-align: center;">
			<h3 class="pageHeaderTableHeader">Edit Contact &amp; Company Xref</h3>
          ...
          <br/>
          <div>
			<input type="button" value="Submit" id="submitContact" onclick="bfdsmgr.contacts.updateCntctMgmtCoXrf();"/>
          </div>
    </div>
