	...
	<body>
		...
		<div id="navigation-block">
        	<ul id="sliding-navigation">
                ...
                <%-- Menu 1 --%>
                <li class="sliding-element"><a href="#">Transmissions</a>
					<ul id="subMenu0">
						<li><a id="view_transmissions" class="sub-menu-element" href="#" onclick="setFieldPage('viewTransmissionsPage');return true">View</a></li>
                        <li><a id="add_transmissions" class="sub-menu-element" href="#" onclick="setFieldPage('addTransmissionPage');return true">Add</a></li> 
						<li><a id="delete_transmissions" class="sub-menu-element" href="#" onclick="bfdsmgr.rep.deleteRep();return true">Delete</a></li>
					</ul>
				</li>
		...
		<div>
			<iframe src="viewTransmissionsPage" id="field-block" frameborder="0"></iframe>
		</div>
	</body>
</html>