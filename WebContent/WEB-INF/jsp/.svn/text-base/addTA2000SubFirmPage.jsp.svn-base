	        ...
	        <table width="*">
	            ...
	            <tr>
	               ...
	               <td>TA2000 NSCC Network Alpha</td>
	                <td><input id="ta2000_nscc_ntwrk_alphaInput" name="ta2000_nscc_ntwrk_alpha" type="text" maxlength=2 size=2 onchange="bfdsmgr.util.setFieldColor(this)" /></td>
	            </tr>
	            <tr colspan=4>
	            ...
	            <tr>
		            ...
		            <td><select id="ta2000_firm_state_cdDD" name="ta2000_firm_state_cd" onchange="bfdsmgr.util.setFieldColor(this)" ></select></td>
	            </tr>
	            <tr>
	                ...
	                <td>
		                <select id="active_indInput" name="active_ind" onchange="bfdsmgr.util.setFieldColor(this); bfdsmgr.tasf.disableInActiveDt()" >
	            ...
	            <tr>
	                <td>Inactive Date</td>
	                <td><input id="inactive_dtInput" name="inactive_dt" type="text" maxlength=10 size=10 disabled onchange="bfdsmgr.util.setFieldColor(this)" /></td>
	            </tr>            
			</table>
		</div>
<!-- Trading Attributes -->		
		...
		<div>            
			<input type="button" value="Submit" id="submitSubFirm" onclick="bfdsmgr.tasf.addTA2000SubFirm();"/>
