	...
	<body>
		...
		<div id="navigation-block">
        	<ul id="sliding-navigation">
                ...
                <%-- Menu 1 --%>
                <li class="sliding-element"><a href="#">Events</a>
					<ul id="subMenu0">
						<li><a id="view_event" class="sub-menu-element" href="#" onclick="setFieldPage('viewEventsPage');return true">View</a></li>
						<li><a id="add_event" class="sub-menu-element" href="#" onclick="setFieldPage('addEventPage');return true">Add</a></li>
						<li><a id="delete_event" class="sub-menu-element" href="#" onclick="setFieldPage('deleteEventPage');return true">Delete</a></li>
					</ul>
				</li>
		...
		<div>
			<iframe src="viewEventsPage" id="field-block" frameborder="0"></iframe>
		</div>
	</body>
</html>