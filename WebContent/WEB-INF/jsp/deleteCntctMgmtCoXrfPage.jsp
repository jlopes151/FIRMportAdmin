...
<head>
    ...
    <title>FIRMport Admin - Delete Contact &amp; Company Xref Page</title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
			bfdsmgr.contacts.deleteContactMgmtcoXref();
        });
    </script>
</head>
...
<div class="bfdsmgrMgmtBody">
	<div id="addContact">
          <div style="text-align: center;">
			<h3 class="pageHeaderTableHeader">Delete Contact &amp; Company Xref</h3>
          </div>
    </div>
