...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {			
        	...
        	bfdsmgr.firm.getOperationalReview();
        	bfdsmgr.firm.getMFProfileII();
        	bfdsmgr.firm.getBatchType();
        	bfdsmgr.firm.getPosFileSched();
...
<div id="addPrimaryFirm" class="bfdsmgrTabBody">
        <table id="addFirmTable" width="100%">
            <tr>
           		<td class="bfdsRequired"><span style='position: absolute; left: 10px;'>required fields *</span></td>
                <td align="center" class="bfdsmgrBoldText"><h3 class="pageHeaderTableHeader">Add Parent Firm</h3></td>
            </tr>
        </table>
...
<!-- General Attributes --> 
		...
		<div id="prmry_frms_tabs-2">       	
			<table>            
<!-- Operational Summary -->            
	        		<td colspan=5 style="text-align: left; color: green" class="bfdsmgrSmallItalicizedText">Operational Summary</td>
	        	</tr>
	            <tr>
	                <td></td>
		<!-- Firm Type Cd -->
		...
		<!-- Clearing Firm Id -->
	            ...
	            <tr>
	                ...
	                <td><input id="op_review_dtInput" name="op_review_dt" type="text" disabled onchange="bfdsmgr.util.setFieldColor(this)" /></td>
	            </tr>
	            <tr>
	                <td>SAE16 (SAS70)</td>
	                <td><select id="sae16_indDD" name="sae16_ind" onchange="bfdsmgr.util.setFieldColor(this)">
	                	<option value="Yes">Yes</option>
	                	<option value="No">No</option>
	                	<option value="TDB" selected>TDB</option>
	                </select></td>
...
<!-- Trading Attributes -->            
		...
		<!-- Data Transmission Method -->
	            ...
	            <tr>
	                ...
	                <td>Inactive Date</td>
	                <td><input id="inactive_dtInput" name="inactive_dt" type="text" maxlength=20 size=20 disabled onchange="bfdsmgr.util.setFieldColor(this)"></td>
	            </tr>
	            <tr>
	                <td>Commserv</td>
	            ...
	            <tr>
	                ...
	                <td><select id="omniserv_indDD" name="omniserv_ind" onchange="bfdsmgr.util.setFieldColor(this)">
	                		<option value="">-- Select --</option>
							<option value="Yes">Yes</option>
							<option value="No">No</option>
						</select>
...
<div>    
	<div>        
		<table id="addSubmitFirmTable" >
		    <tr>
		        <td><input type="button" value="Submit" id="submitFirm" onclick="bfdsmgr.firm.addFirm();" /></td>
		        <td><input type="button" value="Cancel" id="cancelAddFirm" onclick="bfdsmgr.firm.cancelFirm();"/></td>
		    </tr>
		</table>
