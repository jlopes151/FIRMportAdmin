...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
			...
			bfdsmgr.contacts.editContactMgmtcoGrpXrfPage();
        });
    </script>
</head>
...
<div class="bfdsmgrMgmtBody">
	<div id="addContact">
          <div style="text-align: center;">
			<h3 class="pageHeaderTableHeader">Edit Contact &amp; Company Group Xref</h3>
          ...
          <br/>
          <div>
			<input type="button" value="Submit" id="submitContact" onclick="bfdsmgr.contacts.updateCntctMgmtCoGrpXrf();"/>
          </div>
    </div>
