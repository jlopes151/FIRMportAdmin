	...
	<body>
		...
		<div id="navigation-block">
        	<ul id="sliding-navigation">
                ...
                <%-- Menu 1 --%>
                <li class="sliding-element"><a href="#">Agreement</a>
					<ul id="subMenu0">
						<li><a id="view_agree" class="sub-menu-element" href="#" onclick="setFieldPage('viewAgreementPage');return true">View</a></li>
						<li><a id="add_agree" class="sub-menu-element" href="#" onclick="setFieldPage('addAgreementPage');return true">Add</a></li>
						<li><a id="delete_agree" class="sub-menu-element" href="#" onclick="setFieldPage('admin/add');return true">Delete</a></li>
					</ul>
				</li>
		...
		<div>
			<iframe src="viewAgreementPage" id="field-block" frameborder="0"></iframe>
		</div>
	</body>
</html>